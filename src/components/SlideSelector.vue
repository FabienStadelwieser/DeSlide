<template lang="html">
    <div id="slide-selector">
        ...
        <div class="p-4 w-100">
            <div class="clic-slide" v-for="slide in getSlides" :key="slide.nbr" v-on:click="setSelected($event, slide.nbr)">
				<Preview class="preview" :img='slide.img' :nbr="slide.nbr"/>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            setSelected(event, nbr) {
                this.$store.commit('changeSelected', nbr)
            }
        }
    }
</script>
